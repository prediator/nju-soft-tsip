...
{n:"h6",t:"\u6a19\u984c6"},{n:"pre",t:"\u5df2\u7de8\u6392\u683c\u5f0f"},{n:"address",t:"\u5730\u5740"}],pb=[{n:"\u65b0\u7d30\u660e\u9ad4",c:"PMingLiu"},{n:"\u7d30\u660e\u9ad4",c:"mingliu"},{n:"\u6a19\u6977\u9ad4",c:"DFKai-SB"},{n:"\u5fae\u8edf\u6b63\u9ed1\u9ad4",c:"Microsoft JhengHei"},{n:"Arial"},{n:"Arial Narrow"},{n:"Arial Black"},{n:"Comic Sans MS"},{n:"Courier New"},{n:"System"},{n:"Times New Roman"},{n:"Tahoma"},{n:"Verdana"}],R=[{n:"xx-small",wkn:"x-small",s:"8pt",t:"\u6975\u5c0f"},{n:"x-small",
...
shy:"\u5bb3\u7f9e",cute:"\u53ef\u6190",envy:"\u7fa8\u6155",proud:"\u5f97\u610f",struggle:"\u596e\u9b25",quiet:"\u5b89\u975c",shutup:"\u9589\u5634",doubt:"\u7591\u554f",despise:"\u9119\u8996",sleep:"\u7761\u89ba",bye:"\u518d\u898b"}}},ma={Cut:{t:"\u526a\u4e0b (Ctrl+X)"},Copy:{t:"\u8907\u88fd (Ctrl+C)"},Paste:{t:"\u8cbc\u4e0a (Ctrl+V)"},Pastetext:{t:"\u8cbc\u4e0a\u6587\u672c",h:B?0:1},Blocktag:{t:"\u6bb5\u843d\u6a19\u7c64",h:1},Fontface:{t:"\u5b57\u578b",h:1},FontSize:{t:"\u5b57\u578b\u5927\u5c0f",
...
upMediaExt:"wmv,avi,wma,mp3,mid",modalWidth:350,modalHeight:220,modalTitle:true,defLinkText:"\u9ede\u64ca\u6253\u958b\u93c8\u63a5",layerShadow:3,emotMark:false,upBtnText:"\u4e0a\u50b3",wordDeepClean:true,hoverExecDelay:100,html5Upload:true,upMultiple:99},D),Aa=p.plugins,Ba=[];if(Aa){ma=e.extend({},ma,Aa);e.each(Aa,function(a){Ba.push(a)});Ba=Ba.join(",")}if(p.tools.match(/^\s*(m?full|simple|mini)\s*$/i)){var cb=Ja[e.trim(p.tools)];p.tools=p.tools.match(/m?full/i)&&Aa?cb.replace("Table","Table,"+Ba):
cb}p.tools.match(/(^|,)\s*About\s*(,|$)/i)||(p.tools+=",About");p.tools=p.tools.split(",");if(p.editorRoot)V=p.editorRoot;V=aa(V,"abs");if(p.urlBase)p.urlBase=aa(p.urlBase,"abs");var db="xheCSS_"+p.skin,sa="xhe"+ea+"_container",eb="xhe"+ea+"_Tool",fb="xhe"+ea+"_iframearea",gb="xhe"+ea+"_iframe",Ca="xhe"+ea+"_fixffcursor",ta="",ja="",Sa=V+"xheditor_skin/"+p.skin+"/",Da=sb,ya=p.urlType,O=p.urlBase,da=p.emotPath;da=da?da:V+"xheditor_emot/";var Ta="";Da=e.extend({},Da,p.emots);da=aa(da,"rel",O?O:null);
if(qa=p.showBlocktag)ja+=" showBlocktag";var pa=[];this.init=function(){e("#"+db).length===0&&e("head").append('<link id="'+db+'" rel="stylesheet" type="text/css" href="'+Sa+'ui.css" />');var a=p.width||C.style.width||S.outerWidth();T=p.height||C.style.height||S.outerHeight();if(ba(T,"string"))T=T.replace(/[^\d]+/g,"");if(a<=0||T<=0){alert("\u7576\u524dtextarea\u8655\u65bc\u96b1\u85cf\u72c0\u614b\uff0c\u8acb\u5c07\u4e4b\u986f\u793a\u5f8c\u518d\u521d\u59cb\u5316xhEditor\uff0c\u6216\u8005\u76f4\u63a5\u8a2d\u7f6etextarea\u7684width\u548cheight\u6a23\u5f0f");
...
K.find(".xheButton").not("[name=Source],[name=Fullscreen],[name=About]").toggleClass("xheEnabled");setTimeout(Ma,300)}};this.showPreview=function(){var a=p.beforeSetSource,b=d.getSource();if(a)b=a(b);a="<html><head>"+ta+"<title>\u9810\u89bd</title>"+(O?'<base href="'+O+'"/>':"")+"</head><body>"+b+"</body></html>";b=window.screen;b=window.open("","xhePreview","toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width="+Math.round(b.width*0.9)+",height="+Math.round(b.height*
...
e('<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.1.2 (build 101201)</p><p>xhEditor\u662f\u57fa\u65bcjQuery\u958b\u767c\u7684\u8de8\u5e73\u53f0\u8f15\u91cfXHTML\u7de8\u8f2f\u5668\uff0c\u57fa\u65bc<a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>\u958b\u6e90\u5354\u8b70\u767c\u4f48\u3002</p><p>Copyright c <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>');
...
p.upBtnText+'" class="xheBtn" tabindex="-1" /></span>'),k=e(".xheBtn",n),l=p.html5Upload,i=l?p.upMultiple:1;a.after(n);k.before(a);b=b.replace(/{editorRoot}/ig,V);if(b.substr(0,1)==="!")k.click(function(){Q=false;d.showIframeModal("\u4e0a\u50b3\u6587\u4ef6",b.substr(1),g,null,null,function(){Q=true})});else{n.append('<input type="file"'+(i>1?' multiple=""':"")+' class="xheFile" size="13" name="filedata" tabindex="-1" />');var j=e(".xheFile",n);j.change(function(){d.startUpload(j[0],b,c,g)});setTimeout(function(){a.closest(".xheDialog").bind("dragenter dragover",
W).bind("drop",function(f){f=f.originalEvent.dataTransfer;var h;if(l&&f&&(h=f.files)&&h.length>0)d.startUpload(h,b,c,g);return false})},10)}};this.startUpload=function(a,b,c,g){function n(r,s){var u=Object,w=false;try{u=eval("("+r+")")}catch(x){}if(u.err===undefined||u.msg===undefined)alert(b+" \u4e0a\u50b3\u63a5\u53e3\u767c\u751f\u932f\u8aa4\uff01\r\n\r\n\u8fd4\u56de\u7684\u932f\u8aa4\u5167\u5bb9\u70ba: \r\n\r\n"+r);else if(u.err)alert(u.err);else{k.push(u.msg);w=true}if(!w||s)d.removeModal();s&&
w&&g(k);return w}var k=[],l=p.html5Upload,i=l?p.upMultiple:1,j,f,h=e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u50b3\u4e2d\uff0c\u8acb\u7a0d\u5019\u2026\u2026<br /></div>'),o='<img src="'+Sa+'img/loading.gif">';if(!l||a.nodeType&&!((f=a.files)&&f[0])){if(!Ya(a.value,c))return;h.append(o);j=new d.html4Upload(a,b,n)}else{f||(f=a);a=f.length;if(a>i){alert("\u8acb\u4e0d\u8981\u4e00\u6b21\u4e0a\u50b3\u8d85\u904e"+i+"\u500b\u6587\u4ef6");return}for(i=0;i<a;i++)if(!Ya(f[i].fileName,
c))return;var m=e('<div class="xheProgress"><div><span>0%</span></div></div>');h.append(m);j=new d.html5Upload("filedata",f,b,n,function(r){if(r.loaded>=0){var s=Math.round(r.loaded*100/r.total)+"%";e("div",m).css("width",s);e("span",m).text(s+" ( "+Za(r.loaded)+" / "+Za(r.total)+" )")}else m.replaceWith(o)})}var q=Q;if(q)Q=false;d.showModal("\u6587\u4ef6\u4e0a\u50b3\u4e2d(Esc\u53d6\u6d88\u4e0a\u50b3)",h,320,150,function(){Q=q;j.remove()});j.start()};this.html4Upload=function(a,b,c){var g="jUploadFrame"+
...
'<div class="xheModalTitle"><span class="xheModalClose" title="\u95dc\u9589 (Esc)"></span>'+a+"</div>":"")+'<div class="xheModalContent"></div></div>').appendTo("body");Ga=e('<div class="xheModalOverlay"></div>').appendTo("body");if(ga>0)Fa=e('<div class="xheModalShadow" style="width:'+Y.outerWidth()+"px;height:"+Y.outerHeight()+"px;margin-left:-"+(Math.ceil(c/2)-ga-2)+"px;"+(B&&Ea<=7?"":"margin-top:-"+(Math.ceil(g/2)-ga-2)+"px")+'"></div>').appendTo("body");e(".xheModalContent",Y).css("height",g-
...
Ra=Q=true};this.hidePanel=function(){if(Q){fa.removeClass("xheActive");ka.hide();la.hide();L.hide();Q=false;if(!wa){e(".xheFixCancel").remove();wa=true}Ra=ra=false;ca=null}};this.exec=function(a){d.focus();d.hidePanel();d.saveBookmark();var b=ma[a];if(!b)return false;if(P===null){P={};var c=K.find(".xheButton[name="+a+"]");if(c.length===1)P.target=c}if(b.e)b.e.call(d);else{a=a.toLowerCase();switch(a){case "cut":try{v.execCommand(a);if(!v.queryCommandSupported(a))throw"Error";}catch(g){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u526a\u4e0b\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + X)\u4f86\u5b8c\u6210")}break;
case "copy":try{v.execCommand(a);if(!v.queryCommandSupported(a))throw"Error";}catch(n){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8907\u88fd\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + C)\u4f86\u5b8c\u6210")}break;case "paste":try{v.execCommand(a);if(!v.queryCommandSupported(a))throw"Error";}catch(k){alert("\u60a8\u7684\u700f\u89bd\u5668\u5b89\u5168\u8a2d\u7f6e\u4e0d\u5141\u8a31\u4f7f\u7528\u8cbc\u4e0a\u64cd\u4f5c\uff0c\u8acb\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl + V)\u4f86\u5b8c\u6210")}break;
